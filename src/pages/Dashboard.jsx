        ...
        <div className="flex-1 bg-gray-50">
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-5 gap-4 items-stretch">
              ...
              {/* Today's Sales */}
              <div className="col-span-3 bg-white rounded-2xl p-5 shadow-xs">
                <div className="flex justify-between mb-10">
                  <div>
                    <h3 className="font-bold">Today's Sales</h3>
                    <p className="text-xs font-medium text-gray-400">Sales Summary</p>
                  </div>
                  <button className="border border-gray-300 px-2 flex items-center justify-center gap-1 rounded-md w-20 text-xs font-medium">
                    <PiExportBold/>
                    Export
                  </button>
                </div>
                ...
                <div className="grid grid-cols-4 gap-4">
                  ...
                  <StatCard title="Products Sold" value="5" color="bg-green-100" circleColor="bg-green-500" icon={<IoIosPricetag color="white" />} summaryText="+1.2% from yesterday" />
            ...
            <div className="grid grid-cols-7 gap-4">
              ...
              <div className="col-span-2">
                <ChartCard title="Sales Mapping by Country"><SalesMap/></ChartCard>
              </div>
              <div className="col-span-2">
                <ChartCard title="Volume vs Service Level"><VolumeServiceChart/></ChartCard>
              </div>
            </div>
